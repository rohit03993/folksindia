        ...
        return match ($type) {
            ...
            InstituteType::Hospitality => [
                [
                    ...
                    'code' => 'HM-BSC-3Y',
                    'programme_category' => ProgrammeCategory::Hospitality,
                    'duration' => 3,
                    'duration_type' => DurationType::Years,
                    'fee' => 180000,
                    'description' => 'Three-year degree in hotel management with front office, F&B, housekeeping, and food production.',
                ],
                [
                    'name' => 'Diploma in Hotel Management',
                    'code' => 'HM-DIP-18M',
                    'programme_category' => ProgrammeCategory::Certificate,
                    'duration' => 18,
                    'duration_type' => DurationType::Months,
                    'fee' => 95000,
                    'description' => 'Industry-focused diploma covering core hotel operations and practical training.',
                ],
                [
                    ...
                    'duration_type' => DurationType::Months,
                    'fee' => 45000,
                    'description' => 'Short programme focused on kitchen operations, hygiene, and food production skills.',
                ],
            ],
        };
    }
