...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'courses.edit' => 'Update programme name, fee, duration, or website visibility. Optional default installment plan auto-fills admission schedules.',
        'fees.dashboard' => 'Today’s collection, pending totals, and students with overdue installments. Open a student profile to collect or adjust fees.',
