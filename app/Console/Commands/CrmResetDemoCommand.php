...
class CrmResetDemoCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->newLine();
        $this->line('Explore:');
        $this->line('  Student profile → Exam tab — internal assessments with subject columns');
        $this->line('  Student profile → Activities tab — workshops and events');
        $this->line('  Academics → Import Marks — bulk upload rolls 101–103');
        $this->line('  Students — Rohit (101), Sneha (102), Amit (103) in HM Batch A');
