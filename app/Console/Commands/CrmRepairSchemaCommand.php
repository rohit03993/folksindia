...
class CrmRepairSchemaCommand extends Command
{
    ...
    protected $description = 'Repair missing activity/result tables after upgrading from older Folks India schema';
    ...
    public function handle(): int
    {
        ...
        if ($stillMissing !== []) {
            ...
            $this->line('If this persists, run: php artisan crm:reset-app --force');
