...
return [
    ...
    'name' => env('INSTITUTE_NAME', env('APP_NAME', 'Folks India')),

    'tagline' => env('INSTITUTE_TAGLINE', 'Institute of Hotel Management & Hospitality'),

    'number_prefix' => env('INSTITUTE_NUMBER_PREFIX', 'FI'),

    /*
    | Deployment profile — school, coaching, college, or hospitality (hotel management).
    | Super Admin can change this under Setup → Institute Setup (saved in DB).
    */
    'type' => env('INSTITUTE_TYPE', 'hospitality'),

    'seed_demo_data' => filter_var(env('SEED_DEMO_DATA', false), FILTER_VALIDATE_BOOLEAN),

    'hero' => [
        'title' => env('INSTITUTE_HERO_TITLE', 'Build Your Career in Hospitality'),
        'subtitle' => env('INSTITUTE_HERO_SUBTITLE', 'Industry-focused training in hotel management — front office, F&B, housekeeping, and food production. Start your journey with us.'),
    ],

    'about' => env('INSTITUTE_ABOUT', 'We are a hotel management institute offering BSc, Diploma, and Certificate programmes. Our practical, industry-aligned curriculum prepares students for careers in hotels, resorts, cruise lines, and food service worldwide.'),
